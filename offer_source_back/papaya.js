...
function getPage(page) {
    return new Promise(async (ac, rj) => {
        let offers = [];
        try {
            let data = await rp('http://api.appflood.com/s2s_get_p_ads?token=05e8c54e29165625&page=' + page +'&pagesize=5000&incent=0&pricetype=cpi');
            ...
            for (let i in data.offers) {
                ...
                tmpOffer.adv_url = adv_offer.offer_url + '&aff_sub={clickid}&aff_sub3={android}{gaid}{idfa}&aff_sub6={networkid}';
                //tmpOffer.geo = [];
