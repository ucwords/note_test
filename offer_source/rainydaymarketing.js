...
function getPage(page) {
 return new Promise(async (ac, rj) => {
    let opt = {
        url:'http://api.rainydaymarketing.affise.com/3.0/partner/offers?limit=500&page='+page,
        qs:{page:page},
        headers: {
            'User-Agent': 'Leanmobi AI system',
            'API-Key':  'aff3e1672c9f6555795ae0773791c63c9ba4b4b6'
        },
        json: true
    };
    let offers = [];
    try {
        ...
        for (let i in data.offers) {
            ...
            tmpOffer.adv_url = adv_offer.link + '&sub1={clickid}&sub2={network_id}_{sub_id}&sub3='+platform;
