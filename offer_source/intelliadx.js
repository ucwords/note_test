...
function getPage(page) {
    return new Promise(async (ac, rj) => {
        let offers = [];
    try {
        let data = await rp('http://api.intelliadx.com/offers/get.php?token=dbb416a3e4b2799cf1f7e864f0774302');
        //console.log(data);
        ...
        for (let i in data.offers) {
            ...
            tmpOffer.adv_offer_id = adv_offer.trackId+'';
            ...
            tmpOffer.adv_url = adv_offer.trackUrl.replace('{sub}', '{network_id}_{sub_id}');
