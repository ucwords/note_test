...
function getPage(page) {
    return new Promise(async (ac, rj) => {
        let offers = [];
    try {
        let data = await rp('http://click.vimix.mobi/index.php?r=api/getoffers&token=496aec8b0f295eaa20468468aa591df2&limit=1000');
        //console.log(data);
        ...
        for (let i in data.offers) {
            ...
            tmpOffer.adv_url = adv_offer.tracklink.replace('{pubid}', '{network_id}_{sub_id}');
