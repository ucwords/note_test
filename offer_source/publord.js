...
function getPage(page) {
    return new Promise(async (ac, rj) => {
        let offers = [];
    try {
        let data = await rp('http://api.publord.com/168_4f519da4c2fdfa6ac49a07fcbab2475f.json');
        //console.log(data);
        ...
        for (let i in data.offers) {
            ...
            tmpOffer.adv_url = adv_offer.click_url+ '&click_id={clickid}&source_id={network_id}_{sub_id}&google_aid={gaid}&ios_idfa={idfa}';

            tmpOffer.kpi = adv_offer.describe;
