...
function getPage(page) {
    return new Promise(async (ac, rj) => {
        let offers = [];
    try {
        let data = await rp('http://ch-api.rylinkworld.com/?access_id=ry60&token=ead77da9f8c40dbb56a57afe070414d2&timestamp=1542708077&per-page=2000');
        //console.log(data);
        ...
        for (let i in data.data) {
            ...
            tmpOffer.adv_url = adv_offer.tracking_link+ '&cid={clickid}&subchannel={network_id}_{sub_id}&idfa={idfa}&advertiserid={gaid}';
