...
function getPage(page) {
 return new Promise(async (ac, rj) => {
    let offers = [];
    try {
        let data = await rp('https://api.mintegrated.com/affiliate/offer/findAll/?token=Yxak5gbh9d4JYCHBrFM70JL0SOcr4cuQ');
        //console.log(data);
        ...
        for (let i in data.offers) {
            ...
            tmpOffer.adv_url = adv_offer.Tracking_url + '&aff_sub={clickid}&aff_sub2={network_id}_{sub_id}';
