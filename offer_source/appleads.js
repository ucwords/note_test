...
function getPage(page) {
 return new Promise(async (ac, rj) => {
    let offers = [];
    try {
        let data = await rp('http://api.appleadstech.com/v3/api_v3?key=1c5aa92bb6af452d91b55d08e9cd07a8');
        //console.log(data);
        ...
        for (let i in data.data) {
            ...
            tmpOffer.adv_url = adv_offer.click_url + '&aff_sub1={clickid}&source_id={network_id}_{sub_id}&google_aid={gaid}&ios_idfa={idfa}';
